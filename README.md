...
| エイリアス | モデル名 |
|-----------|---------|
| `super-gemma` | Super Gemma 4 26B Uncensored |
| `llama4` | Llama 4 Scout 17B-16E Abliterated |
| `qwen25` | Qwen 2.5 7B Abliterated |
| `dark-champion` | LLaMA-3.2 Dark Champion 18.4B Abliterated |
...
make pull MODEL=llama4       # モデルを手動で pull
```
